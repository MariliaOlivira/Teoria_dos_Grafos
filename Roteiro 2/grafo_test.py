...
class TestGrafo(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.g_p_bfs_E.adicionaAresta('a7', 'M', 'C')
        ...
        self.g_p_dfs_M.adicionaAresta('a5', 'P', 'C')
        ...
        self.g_p_dfs_T.adicionaAresta('a5', 'P', 'C')
        ...
        self.g_p_dfs_C.adicionaAresta('a5', 'P', 'C')
    ...
    def test_bfs(self):
        ...
        self.assertTrue(self.g_p.bfs("Z") ==  self.g_p_bfs_Z)
        self.assertTrue(self.g_p.bfs("T") ==  self.g_p_bfs_T)
        self.assertTrue(self.g_p.bfs("P") ==  self.g_p_bfs_P)
        self.assertTrue(self.g_p.bfs("M") ==  self.g_p_bfs_M)
        self.assertTrue(self.g_p.bfs("E") ==  self.g_p_bfs_E)
        self.assertTrue(self.g_p.bfs("J") ==  self.g_p_bfs_J)
                
    
    def test_dfs(self):
        self.assertTrue(self.g_p.dfs("J") == self.g_p_dfs_J)
        self.assertTrue(self.g_p.dfs("Z") == self.g_p_dfs_Z)
        self.assertTrue(self.g_p.dfs("T") == self.g_p_dfs_T)
